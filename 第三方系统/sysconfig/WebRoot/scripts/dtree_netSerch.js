...
function Node(id, pid, name, url, title, checkName,target, icon, iconOpen, open,isCheckBox) {
...
treeCheckBox.prototype.add = function(id, pid, name, url, title, checkName, target, icon, iconOpen, open,isCheckBox) {

	this.aNodes[this.aNodes.length] = new Node(id, pid, name, url, title, checkName, target, icon, iconOpen, open,isCheckBox);
...
treeCheckBox.prototype.node = function(node, nodeId) {
	...
	if(this.config.check){
		...
		if(node.pid==-1){
          if(node.isCheckBox){
          	str+= '<input type="checkbox"' + nameStr + ' id="c'+ this.obj + nodeId + '"  value ="' + node.id+ '" onclick="javascript:'+this.obj+'.cc0('+nodeId+')"/>';

          }else{
          	str+= '<input type="checkbox"  style="display:none"' + nameStr + ' id="c'+ this.obj + nodeId + '"  value ="' + node.id+ '" onclick="javascript:'+this.obj+'.cc0('+nodeId+')"/>';
